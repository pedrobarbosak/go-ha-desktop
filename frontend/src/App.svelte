...
<div class="min-h-screen bg-gray-100 dark:bg-gray-900 text-gray-900 dark:text-gray-100">
	<nav class="bg-white dark:bg-gray-800 shadow-md p-4">
		<div class="container mx-auto flex justify-between items-center">
			<a class="text-xl font-bold" href="/#">HA-Desktop</a>
			<div class="space-x-4">
				<a class="hover:text-blue-500 transition-colors" href="/#">Devices</a>
				<a class="hover:text-blue-500 transition-colors" href="/#settings">Settings</a>
			</div>
		</div>
	</nav>
